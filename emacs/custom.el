...
(custom-set-variables
 ...
 '(line-spacing 0.2)
 '(org-agenda-files
   '("~/org/20200711225040-post_hoc_reasoning.org" "~/org/notes/20200524150544_small_percentages_in_a_large_world.org"))
 ...
 '(org-roam-new-file-directory "~/org/notes" t)
 '(package-selected-packages
   '(sass-mode graphql-mode json-mode flycheck rjsx-mode yaml-mode web-mode use-package undo-tree smartparens rust-mode projectile-ripgrep php-mode org-roam org-pomodoro org-bullets neotree markdown-mode magit js2-mode hc-zenburn-theme haskell-mode fill-column-indicator ein edbi csv-mode counsel company all-the-icons))
